var keyArray = ["MALES","FEMALES","AGE_22_29","AGE_30_39","OWNER_OCC","RENTER_OCC","VACANT"]; //array of property keys
...
function highlight(data){
  ...
  d3.select("#"+props.FIPS) //select the current region in the DOM
  ...
  .attr("id", props.FIPS+"label") //for styling label
...
function dehighlight(data){
  ...
  var props = data.properties; //json properties
  var region = d3.select("#"+props.FIPS); //select the current region
